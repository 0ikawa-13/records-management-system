...
<div class="bg-white shadow px-4 md:px-6 py-3 flex justify-between items-center">
  ...
  <div class="flex items-center gap-3">
    <a href="reports.php"
       class="bg-sky-400 hover:bg-sky-500 text-white px-4 py-2 rounded-lg text-sm md:text-base">
      Reports
    </a>

    <a href="logout.php"
       class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-sm md:text-base">
      Logout
    </a>
  </div>
